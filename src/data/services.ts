...
export const SERVICES: Service[] = [
  ...
  // C. Diagnostics
  {
    id: "obd-computer-diagnostic",
    name: "OBD Computer Diagnostic",
    category: "C. Diagnostics",
    minPrice: 95,
    maxPrice: 145,
    description: "Hourly diagnostic service - Computer diagnostic scan and error code reading",
    tooltip: "Full OBD2 scanner reading to identify engine warning lights and fault codes. Billed hourly at $95-$145/hour.",
  ...
  },
  {
    ...
    minPrice: 95,
    maxPrice: 145,
    description: "Hourly diagnostic service - Electrical system troubleshooting",
    tooltip: "In-depth electrical system testing and diagnostics for charging, starting, and lighting issues. Billed hourly at $95-$145/hour.",
    partsAvailable: false,
  },
  {
    id: "wiring-electrical-troubleshooting",
    name: "Wiring / Electrical Troubleshooting",
    category: "C. Diagnostics",
    minPrice: 95,
    maxPrice: 145,
    description: "Hourly diagnostic service - Wiring and electrical circuit troubleshooting",
    tooltip: "Advanced wiring and electrical circuit diagnosis. Billed hourly at $95-$145/hour.",
    partsAvailable: false,
  },
  {
    id: "advanced-computer-diagnostics",
    name: "Advanced Computer / Module Diagnostics",
    category: "C. Diagnostics",
    minPrice: 95,
    maxPrice: 145,
    description: "Hourly diagnostic service - Advanced module and computer diagnostics",
    tooltip: "In-depth diagnostics for advanced vehicle modules and computer systems. Billed hourly at $95-$145/hour.",
    partsAvailable: false,
  },
  {
    id: "no-start-hard-start-diagnostics",
    name: "No-Start / Hard-Start Diagnostics",
    category: "C. Diagnostics",
    minPrice: 95,
    maxPrice: 145,
    description: "Hourly diagnostic service - Starting and hard-start troubleshooting",
    tooltip: "Comprehensive diagnostics for vehicles that won't start or have hard-start conditions. Billed hourly at $95-$145/hour.",
    partsAvailable: false,
  },
